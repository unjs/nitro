...
import { generateFSTree } from "./utils";
import { getRollupConfig, RollupConfig } from "nitropack/rollup";
import {
  prettyPath,
  writeFile,
  isDirectory,
...
export async function writeTypes(nitro: Nitro) {
  ...
  const routes = [
    "// Generated by nitro",
    'import type { Serialize, Simplify } from "nitropack/schema";',
    'declare module "nitropack/schema" {',
