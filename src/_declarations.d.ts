// TODO: remove when updating serve-placeholder to a version with bundler-compatible types
declare module "serve-placeholder" {
  ...
  declare type ServerMiddleware = (
    req: IncomingMessage,
    res: ServerResponse,
    next: () => void
  ) => void;
  declare function servePlaceholder(
