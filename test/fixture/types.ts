...
describe('API routes', () => {
  ...
  it('generates the correct type depending on the method used', () => {
    expectTypeOf($fetch('/api/methods', { method: 'get' })).toMatchTypeOf<Promise<'Index get'>>()
    expectTypeOf($fetch('/api/methods', { method: 'post' })).toMatchTypeOf<Promise<'Index post'>>()
    expectTypeOf($fetch('/api/methods/default', { method: 'get' })).toMatchTypeOf<Promise<'Default route'>>()
    expectTypeOf($fetch('/api/methods/default', { method: 'put' })).toMatchTypeOf<Promise<'Default route'>>()
    expectTypeOf($fetch('/api/methods/default', { method: 'post' })).toMatchTypeOf<Promise<'Default override'>>()
  })
})
