...
Follow the (openapi-typescript OperationObject type)[url(https://github.com/drwpow/openapi-typescript/blob/main/packages/openapi-typescript/src/types.ts)] or (swagger 3.0 specification)[url(https://swagger.io/specification/v3/)] to see the available options.
