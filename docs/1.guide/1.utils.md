...
::read-more{to="https://github.com/unjs/nitro/blob/main/src/core/config/resolvers/imports.ts"}
Check [the source code](https://github.com/unjs/nitro/blob/main/src/core/config/resolvers/imports.ts) for list of available Nitro auto imports.
::
