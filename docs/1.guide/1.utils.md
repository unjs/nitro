...
::read-more{to="https://github.com/unjs/nitro/blob/main/src/core/config/resolvers/imports.ts#L58"}
Check [the source code](https://github.com/unjs/nitro/blob/main/src/core/config/resolvers/imports.ts#L58) for list of available Nitro auto imports.
::
