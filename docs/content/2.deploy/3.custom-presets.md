...
Custom presets are local files that have a preset entry that defines builder configuration and a runtime entrypoint.
...
First we have to define our preset entrypoint in a local directory `preset/index.ts`
...
The entrypoint will be used by your server or provider, and you can fully customise its behaviour.
...
Refer to the Nitro [source code](https://github.com/unjs/nitro/tree/main/src) directly to have a better understanding of presets and entrypoints.
